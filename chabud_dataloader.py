...
class ChabudDataset(data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        img_post = rio.open(data['images'][0]['file_name']).read()
...
chabud_train = ChabudDataset(json_dir='../CHABUD/vectors/Original_Split-20230524T135331/MASK',data_list = train_list,transform = Rescale_train(256),target_transform = Rescale_target(256))
chabud_val = ChabudDataset(json_dir='../CHABUD/vectors/Original_Split-20230524T135331/MASK',data_list = val_list,transform = Rescale_train(256),target_transform = Rescale_target(256))
